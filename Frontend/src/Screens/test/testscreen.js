...
const cart = [
  {
    ...
    product_shopping_image: "https:",
    total_price: 8000,
    quantity: 3,
    unique_product_id: 34,
    seller_id: 3,
    product_types: [
      {
        product_type_id: "1",
  ...
  },
  {
    ...
    product_types: [
      {
        product_type_id: "6",
        product_type_name: "Kids cloth",
        attributes: [
          {
            attribute_name: "Kid Chest",

            achara_value: "24",
          },
          {
            attribute_name: "Kid waist",
      ...
      {
        product_type_id: "6",
        product_type_name: "kids pant ",
        attributes: [
          {
            attribute_name: "thigh size",
...
const orderArray = {
  order_details: {
    customer_id: "amanc1248@gmail.com",
    total_price: 8000,
  ...
  ordered_unique_products: [
    {
      ordered_unique_product_id: "AUTO GENERATED",
      order_id: "FETCHED",
      product_id: "1",
      product_name: "Womens Achara",
      unique_product_id: "2",
      ...
      quantity: 4,
      price: 6000,
      order_product_requirements: [
        {
          order_product_requirements_id: "AUTO GENERATED",
          ordered_unique_product_id: "FETCHED",
          product_type_name: "Achara Cloth",
          size_attribute_name: "Achara Length",
          size_attribute_value: 4.5,
        },
        {
          order_product_requirements_id: "AUTO GENERATED",
          ordered_unique_product_id: "FETCHED",
          product_type_name: "Achara Cloth",
          size_attribute_name: "Achara Color",
          size_attribute_value: "White",
        },
      ],
    },
    {
      ordered_unique_product_id: 1,
      order_id: "FETCHED",
      product_id: "1",
      product_name: "Womens Achara",
      unique_product_id: "2",
